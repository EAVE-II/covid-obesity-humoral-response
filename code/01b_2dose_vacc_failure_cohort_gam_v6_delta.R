...
covid_hosp_death <- filter(covid_hosp_death,admission_date<"2021-12-15")
covid_hosp_death <- filter(covid_hosp_death,SpecimenDate<"2021-12-15")
covid_hosp_death <- filter(covid_hosp_death,admission_date>"2021-05-18")
covid_hosp_death <- filter(covid_hosp_death,SpecimenDate>"2021-05-18")
Vaccinations <- filter(Vaccinations, is.na(date_vacc_1)|date_vacc_1<"2021-12-15")
Vaccinations <- filter(Vaccinations, is.na(date_vacc_2)|date_vacc_2<"2021-12-15")
Vaccinations <- filter(Vaccinations, is.na(date_vacc_3)|date_vacc_3<"2021-12-15")
...
df_all<-df
df_all <- filter(df_all,is.na(covid_hosp_death_date)|covid_hosp_death_date<"2021-12-15")
df_all <- filter(df_all,is.na(covid_hosp_death_date)|covid_hosp_death_date>"2021-05-18")
###########################
seed <- 39021954
...
df_cohort_vacc<-mutate(df_cohort_vacc,
                       date_preiod_b_1428 = if_else(analysis_end_date_c>(date_vacc_3_13+27),(date_vacc_3_13+27),analysis_end_date_c))
df_cohort_vacc<-mutate(df_cohort_vacc,
...
saveRDS(df_all, paste0(project_path,"/data/df_cohort_vacc_15-03-2022_gam_full_d.rds"))
saveRDS(df_cohort_vacc, paste0(project_path,"/data/df_cohort_vacc_15-03-2022_gam_d.rds"))
saveRDS(df_cohort_vacc_g, paste0(project_path,"/data/df_cohort_vacc_g_15-03-2022_gam_d.rds"))
