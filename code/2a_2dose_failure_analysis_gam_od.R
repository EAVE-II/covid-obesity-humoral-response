...
df_cohort_vacc <- readRDS(paste0(project_path,"/data/df_cohort_vacc_15-03-2022_gam_d.rds"))
df_cohort_vacc_g <- readRDS(paste0(project_path,"/data/df_cohort_vacc_g_15-03-2022_gam_d.rds"))
df_cohort_vacc <- readRDS(paste0(project_path,"/data/df_cohort_vacc_15-03-2022_gam_o.rds"))
df_cohort_vacc_g <- readRDS(paste0(project_path,"/data/df_cohort_vacc_g_15-03-2022_gam_0.rds"))
...
a_end_alpha <- as.Date("2021-05-19")
a_end_delta <- as.Date("2021-12-15")

#df_cohort_vacc_g_alpha <- df_cohort_vacc_g %>% filter(end_date < a_end_alpha) 
df_cohort_vacc_g <- df_cohort_vacc_g %>% filter(start_date >= a_end_alpha &
                                                  end_date < a_end_delta)
...
write.csv(z,paste0(project_path,"/output/ARR_14-28_days_as_ref_b_o.csv"))
write.csv(z,paste0(project_path,"/output/ARR_14-28_days_as_ref_b_d.csv"))
