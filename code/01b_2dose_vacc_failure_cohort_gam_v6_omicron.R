...
Vaccinations <- filter(Vaccinations, is.na(date_vacc_2)|date_vacc_2>="2021-12-01")
Vaccinations <- filter(Vaccinations, is.na(date_vacc_3)|date_vacc_3>="2021-12-01")
...
saveRDS(df_all, paste0(project_path,"/data/df_cohort_vacc_15-03-2022_gam_full_o.rds"))
saveRDS(df_cohort_vacc, paste0(project_path,"/data/df_cohort_vacc_15-03-2022_gam_o.rds"))
saveRDS(df_cohort_vacc_g, paste0(project_path,"/data/df_cohort_vacc_g_15-03-2022_gam_0.rds"))
