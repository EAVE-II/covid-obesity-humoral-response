...
df_cohort_vacc_g <- filter(df_cohort_vacc_g, pv_period_f!="v3_02:4")
df_cohort_vacc_g <- filter(df_cohort_vacc_g, pv_period_f!="v3_5:8")
df_cohort_vacc_g <- filter(df_cohort_vacc_g, pv_period_f!="v3_9+")
